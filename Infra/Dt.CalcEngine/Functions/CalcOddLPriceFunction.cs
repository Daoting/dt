...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> price per $100 face value of a security having an odd (short or long) last coupon period.
    /// </summary>
    public class CalcOddLPriceFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        /// The args contains 7 - 8 items: settlement, maturity, last_interest, rate, yld, redemption, frequency, [basis].
        /// </para>
        /// <para>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            double yield = CalcConvert.ToDouble(args[4]);
            ...
            if (((((basis >= 0) && (basis <= 4)) && (((freq == 1) || (freq == 2)) || (freq == 4))) && ((DateTime.Compare(time, time2) <= 0) && (DateTime.Compare(time3, time) <= 0))) && (((rate >= 0.0) && (yield >= 0.0)) && (redemption > 0.0)))
            {
                return (double) this.calc_oddlprice(time, time2, time3, rate, yield, redemption, freq, basis);
            }
