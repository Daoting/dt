...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> yield for a Treasury bill.
    /// </summary>
    public class CalcTBillYieldFunction : CalcBuiltinFunction
    {
        /// <summary>
        /// Returns the <see cref="T:System.Double" /> yield for a Treasury bill.
        /// </summary>
        /// <param name="args"><para>
        /// The args contains 3 items: settlement, maturity, pr.
        /// </para>
        /// <para>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return (double) (((100.0 - num) / num) * (360.0 / num2));
        }
