...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> discount rate for a security.
    /// </summary>
    public class CalcDiscFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            if (DateTime.Compare(time, time2) < 0)
            {
                ...
                {
                    return (double) (((num2 - num) / num2) * (num5 / num4));
                }
            }
            return CalcErrors.Number;
        }
