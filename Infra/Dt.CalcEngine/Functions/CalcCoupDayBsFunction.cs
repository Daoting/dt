...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> number of days from the beginning of the coupon period to the settlement date.
    /// </summary>
    public class CalcCoupDayBsFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            int basis = CalcHelper.ArgumentExists(args, 3) ? CalcConvert.ToInt(args[3]) : 0;
            if ((basis < 0) || (basis > 4))
            {
            ...
            return (double) FinancialHelper.coupdaybs(time, time2, freq, basis);
        }
