...
{
    /// <summary>
    /// Averages the values in a field (column) of records in a list
    /// or database that match conditions you specify.
    /// </summary>
    public class CalcDAverageFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                {
                    double num3;
                    if (!CalcConvert.TryToDouble(current, out num3, true))
                    {
