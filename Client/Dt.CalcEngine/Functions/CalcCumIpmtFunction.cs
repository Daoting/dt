...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> cumulative interest paid on a loan between start_period and end_period.
    /// </summary>
    public class CalcCumIpmtFunction : CalcBuiltinFunction
    {
        /// <summary>
        /// Returns the <see cref="T:System.Double" /> cumulative interest paid on a loan between start_period and end_period.
        /// </summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            {
                return (double) this.get_cumipmt(fRate, nNumPeriods, fVal, nStart, nEnd, nPayType);
            }
