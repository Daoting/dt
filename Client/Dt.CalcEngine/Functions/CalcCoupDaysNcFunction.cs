...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> number of days from the settlement date to the next coupon date.
    /// </summary>
    public class CalcCoupDaysNcFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return (double) FinancialHelper.coupdaysnc(time, time2, freq, basis);
        }
