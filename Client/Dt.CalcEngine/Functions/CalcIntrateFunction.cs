...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> interest rate for a fully invested security.
    /// </summary>
    public class CalcIntrateFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        /// The args contains 4 - 5 items: settlement, maturity, investment, redemption, [basis].
        /// </para>
        /// <para>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            if (DateTime.Compare(time, time2) < 0)
            {
                ...
                {
                    return (double) (((num2 - num) / num) * (num5 / num4));
                }
            }
            return CalcErrors.Number;
        }
