...
namespace Dt.Core
{
    ...
    public abstract partial class Stub
    {
        ...
        internal abstract void ShowLogin(bool p_isPopup);
        ...
        /// </summary>
        internal abstract void ShowHome();

        /// <summary>
        /// 注册接收服务器推送
        /// </summary>
        internal abstract void RegisterSysPush();

        /// <summary>
        /// 主动停止接收推送
        /// </summary>
        internal abstract void StopSysPush();
        ...
        /// <returns>返回打开的窗口或视图，null表示打开失败</returns>
        internal abstract object OpenView(string p_viewName, string p_title, Icons p_icon, object p_params);
        ...
        /// </summary>
        /// <returns></returns>
        internal protected abstract Task OnSuspending();

        /// <summary>
        /// 恢复会话时的处理，手机或PC平板模式下再次占据屏幕时触发
        /// </summary>
        internal protected abstract void OnResuming();
