...
namespace Dt.Core
{
    ...
    public static class AtUser
    {
        ...
        {
            get { return AtLocal.GetCookie("LoginID"); }
        }
        ...
        {
            get { return AtLocal.GetCookie("LoginPhone"); }
        }
        ...
        {
            get { return AtLocal.GetCookie("AccessToken"); }
        }
        ...
        {
            get { return !string.IsNullOrEmpty(AtLocal.GetCookie("LoginID")); }
        }
        #endregion
        ...
        /// 获取固定菜单项个数
        /// </summary>
        public static int FixedMenusCnt
        {
            get
            {
        ...
        /// 加载当前登录用户的菜单，性能已调优
        /// </summary>
        internal static void LoadMenus()
        {
            // 所有可访问项
            ...
            var favMenu = AtLocal.DeferredQuery<MenuFav>($"select menuid from menufav where userid='{ID}' order by clicks desc limit 0,6");
        ...
        /// <returns></returns>
        internal static List<OmMenu> LoadGroupMenus(OmMenu p_parentMenu)
        {
            // 确保子菜单项的顺序
        ...
        /// <returns></returns>
        internal static List<OmMenu> LoadMenusByName(string p_filter)
        {
        ...
        /// <returns></returns>
        internal static string GetMenuPath(OmMenu p_menu)
        {
            StringBuilder sb = new StringBuilder();
            if (p_menu != null)
            {
