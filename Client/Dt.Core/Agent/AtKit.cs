...
namespace Dt.Core
{
    ...
    public static class AtKit
    {
        ...
        /// 获取内置表达式的值
        /// </summary>
        /// <param name="p_exp"></param>
        /// <returns></returns>
        public static string GetExpValue(string p_exp)
        {
            ValExp exp;
