...
namespace Dt.Charts
{
    internal class ChartTypes
    {
        ...
        internal static ChartSubtype GetSubtype(string name)
        {
            ...
            foreach (ChartTypeInfo info2 in Gallery)
            {
        ...
        public static List<ChartTypeInfo> Gallery
        {
            get
            {
                List<ChartTypeInfo> list = null;
                int num = 1;
                if (_galleries.ContainsKey(num))
                {
                    list = _galleries[num];
                }
                if (list == null)
                {
                    list = new List<ChartTypeInfo>();
                    Bar bar = new Bar();
