...
namespace Dt.Mgr.Module
{
    public partial class RptViewParamsDlg : Dlg
    {
        ...
        async void OnAddParams(object sender, RoutedEventArgs e)
        {
            ...
            await ParamsForm.Open(-1);
        }

        async void OnParamsDoubleClick(object obj)
        {
            await ParamsForm.Open(_lvParams.SelectedRow?.ID);
        }

        async void OnEditParams(Mi e)
        {
            await ParamsForm.Open(e.Row?.ID);
        }
        ...
        {
            await ParamsForm.Update(_lvParams.SelectedRow?.ID);
        }
    }
}