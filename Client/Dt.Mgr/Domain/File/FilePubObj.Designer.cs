...
{
    [Tbl("cm_file_pub")]
    public partial class FilePubObj : Entity
    {
        #region 构造方法
        FilePubObj() { }

        public FilePubObj(CellList p_cells) : base(p_cells) { }
        ...
        public static Task<FilePubObj> GetByID(string p_id)
        {
            return EntityEx.GetByID<FilePubObj>(p_id);
        }
        ...
        /// <param name="p_id">主键</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<FilePubObj> GetByID(long p_id)
        {
            return EntityEx.GetByID<FilePubObj>(p_id);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<FilePubObj> GetByKey(string p_keyName, string p_keyVal)
        {
            return EntityEx.GetByKey<FilePubObj>(p_keyName, p_keyVal);
        }
        ...
        {
            return EntityEx.DelByID<FilePubObj>(p_id, p_isNotify);
        }
        ...
        public static Task<Table<FilePubObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<FilePubObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<FilePubObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<FilePubObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<FilePubObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<FilePubObj>(p_filter, p_params);
        }
        ...
        {
            return EntityEx.GetNewID<FilePubObj>();
        }
        ...
        {
            return EntityEx.GetNewSeq<FilePubObj>(p_colName);
        }
        #endregion
    }
}