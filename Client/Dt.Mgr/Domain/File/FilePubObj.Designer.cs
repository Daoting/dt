...
namespace Dt.Mgr.Domain
{
    ...
    public partial class FilePubObj : Entity
    {
        ...
        {
            return EntityEx.DelByKey<FilePubObj>(p_keyName, p_keyVal);
        }
        ...
        public static Task<Table<FilePubObj>> Query(string p_filter = null)
        {
            return EntityEx.Query<FilePubObj>();
        }
        ...
        /// <returns>返回实体列表</returns>
        public static Task<Table<FilePubObj>> Page(int p_starRow, int p_pageSize, string p_filter = null)
        {
            return EntityEx.Page<FilePubObj>(p_starRow, p_pageSize, p_filter);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<FilePubObj> First(string p_filter)
        {
            return EntityEx.First<FilePubObj>(p_filter);
        }
