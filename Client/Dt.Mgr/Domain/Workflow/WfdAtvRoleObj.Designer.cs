...
namespace Dt.Mgr.Domain
{
    ...
    public partial class WfdAtvRoleObj : Entity
    {
        ...
        public static Task<Table<WfdAtvRoleObj>> Query(string p_filter = null)
        {
            return EntityEx.Query<WfdAtvRoleObj>();
        }
        ...
        /// <returns>返回实体列表</returns>
        public static Task<Table<WfdAtvRoleObj>> Page(int p_starRow, int p_pageSize, string p_filter = null)
        {
            return EntityEx.Page<WfdAtvRoleObj>(p_starRow, p_pageSize, p_filter);
        }
        ...
        public static Task<WfdAtvRoleObj> First(string p_filter)
        {
            return EntityEx.First<WfdAtvRoleObj>(p_filter);
        }
