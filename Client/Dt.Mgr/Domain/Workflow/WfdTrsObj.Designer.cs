...
namespace Dt.Mgr.Domain
{
    ...
    public partial class WfdTrsObj : Entity
    {
        ...
        public static Task<WfdTrsObj> GetByID(string p_id)
        {
            return EntityEx.GetByID<WfdTrsObj>(p_id);
        }
        ...
        /// <param name="p_id">主键</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<WfdTrsObj> GetByID(long p_id)
        {
            return EntityEx.GetByID<WfdTrsObj>(p_id);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<WfdTrsObj> GetByKey(string p_keyName, string p_keyVal)
        {
            return EntityEx.GetByKey<WfdTrsObj>(p_keyName, p_keyVal);
        }
        ...
        {
            return EntityEx.DelByID<WfdTrsObj>(p_id, p_isNotify);
        }
        ...
        public static Task<Table<WfdTrsObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<WfdTrsObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<WfdTrsObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<WfdTrsObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<WfdTrsObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<WfdTrsObj>(p_filter, p_params);
        }
        ...
        {
            return EntityEx.GetNewID<WfdTrsObj>();
        }
        ...
        {
            return EntityEx.GetNewSeq<WfdTrsObj>(p_colName);
        }
        #endregion
    }
}