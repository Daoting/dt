...
namespace Dt.Mgr.Domain
{
    ...
    public partial class WfiPrcObj : Entity
    {
        ...
        public WfiPrcObj(CellList p_cells) : base(p_cells) { }
        ...
        public static Task<Table<WfiPrcObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<WfiPrcObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<WfiPrcObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<WfiPrcObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<WfiPrcObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<WfiPrcObj>(p_filter, p_params);
        }
