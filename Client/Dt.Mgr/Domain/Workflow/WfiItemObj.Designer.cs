...
namespace Dt.Mgr.Domain
{
    ...
    public partial class WfiItemObj : Entity
    {
        ...
        public static Task<Table<WfiItemObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<WfiItemObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<WfiItemObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<WfiItemObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<WfiItemObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<WfiItemObj>(p_filter, p_params);
        }
