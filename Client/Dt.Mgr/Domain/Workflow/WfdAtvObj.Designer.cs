...
namespace Dt.Mgr.Domain
{
    ...
    public partial class WfdAtvObj : Entity
    {
        ...
        public WfdAtvObj(CellList p_cells) : base(p_cells) { }
        ...
        public static Task<Table<WfdAtvObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<WfdAtvObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<WfdAtvObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<WfdAtvObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<WfdAtvObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<WfdAtvObj>(p_filter, p_params);
        }
