...
namespace Dt.Mgr.Domain
{
    ...
    public partial class WfiTrsObj : Entity
    {
        ...
        {
            return EntityEx.DelByKey<WfiTrsObj>(p_keyName, p_keyVal);
        }
        ...
        public static Task<Table<WfiTrsObj>> Query(string p_filter = null)
        {
            return EntityEx.Query<WfiTrsObj>();
        }
        ...
        /// <returns>返回实体列表</returns>
        public static Task<Table<WfiTrsObj>> Page(int p_starRow, int p_pageSize, string p_filter = null)
        {
            return EntityEx.Page<WfiTrsObj>(p_starRow, p_pageSize, p_filter);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<WfiTrsObj> First(string p_filter)
        {
            return EntityEx.First<WfiTrsObj>(p_filter);
        }
