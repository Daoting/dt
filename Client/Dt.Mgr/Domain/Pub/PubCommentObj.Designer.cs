...
namespace Dt.Mgr.Domain
{
    ...
    public partial class PubCommentObj : Entity
    {
        ...
        {
            return EntityEx.DelByKey<PubCommentObj>(p_keyName, p_keyVal);
        }
        ...
        public static Task<Table<PubCommentObj>> Query(string p_filter = null)
        {
            return EntityEx.Query<PubCommentObj>();
        }
        ...
        /// <returns>返回实体列表</returns>
        public static Task<Table<PubCommentObj>> Page(int p_starRow, int p_pageSize, string p_filter = null)
        {
            return EntityEx.Page<PubCommentObj>(p_starRow, p_pageSize, p_filter);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<PubCommentObj> First(string p_filter)
        {
            return EntityEx.First<PubCommentObj>(p_filter);
        }
