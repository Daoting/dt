...
namespace Dt.Mgr.Domain
{
    ...
    public partial class PubCommentObj : Entity
    {
        ...
        public PubCommentObj(CellList p_cells) : base(p_cells) { }
        ...
        {
            return EntityEx.DelByID<PubCommentObj>(p_id, p_isNotify);
        }
        ...
        public static Task<Table<PubCommentObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<PubCommentObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<PubCommentObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<PubCommentObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<PubCommentObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<PubCommentObj>(p_filter, p_params);
        }
