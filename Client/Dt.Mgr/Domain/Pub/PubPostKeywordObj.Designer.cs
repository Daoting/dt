...
namespace Dt.Mgr.Domain
{
    ...
    public partial class PubPostKeywordObj : Entity
    {
        ...
        public PubPostKeywordObj(CellList p_cells) : base(p_cells) { }
        ...
        public static Task<Table<PubPostKeywordObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<PubPostKeywordObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<PubPostKeywordObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<PubPostKeywordObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        public static Task<PubPostKeywordObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<PubPostKeywordObj>(p_filter, p_params);
        }
