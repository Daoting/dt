...
namespace Dt.Mgr.Domain
{
    ...
    public partial class PubPostKeywordObj : Entity
    {
        ...
        public static Task<Table<PubPostKeywordObj>> Query(string p_filter = null)
        {
            return EntityEx.Query<PubPostKeywordObj>();
        }
        ...
        /// <returns>返回实体列表</returns>
        public static Task<Table<PubPostKeywordObj>> Page(int p_starRow, int p_pageSize, string p_filter = null)
        {
            return EntityEx.Page<PubPostKeywordObj>(p_starRow, p_pageSize, p_filter);
        }
        ...
        public static Task<PubPostKeywordObj> First(string p_filter)
        {
            return EntityEx.First<PubPostKeywordObj>(p_filter);
        }
