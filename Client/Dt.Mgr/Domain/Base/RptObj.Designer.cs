...
namespace Dt.Mgr.Domain
{
    ...
    public partial class RptObj : Entity
    {
        ...
        public static Task<RptObj> GetByID(string p_id)
        {
            return EntityEx.GetByID<RptObj>(p_id);
        }
        ...
        /// <param name="p_id">主键</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<RptObj> GetByID(long p_id)
        {
            return EntityEx.GetByID<RptObj>(p_id);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<RptObj> GetByKey(string p_keyName, string p_keyVal)
        {
            return EntityEx.GetByKey<RptObj>(p_keyName, p_keyVal);
        }
        ...
        {
            return EntityEx.DelByID<RptObj>(p_id, p_isNotify);
        }
        ...
        public static Task<Table<RptObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<RptObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<RptObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<RptObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<RptObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<RptObj>(p_filter, p_params);
        }
        ...
        {
            return EntityEx.GetNewID<RptObj>();
        }
        ...
        {
            return EntityEx.GetNewSeq<RptObj>(p_colName);
        }
        #endregion
    }
}