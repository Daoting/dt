...
namespace Dt.Mgr.Domain
{
    ...
    public partial class OptionObj : Entity
    {
        ...
        public static Task<Table<OptionObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<OptionObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<OptionObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<OptionObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        public static Task<OptionObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<OptionObj>(p_filter, p_params);
        }
