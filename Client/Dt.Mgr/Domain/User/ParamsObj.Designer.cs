...
namespace Dt.Mgr.Domain
{
    ...
    public partial class ParamsObj : Entity
    {
        ...
        public static Task<ParamsObj> GetByID(string p_id)
        {
            return EntityEx.GetByID<ParamsObj>(p_id);
        }
        ...
        /// <param name="p_id">主键</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<ParamsObj> GetByID(long p_id)
        {
            return EntityEx.GetByID<ParamsObj>(p_id);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<ParamsObj> GetByKey(string p_keyName, string p_keyVal)
        {
            return EntityEx.GetByKey<ParamsObj>(p_keyName, p_keyVal);
        }
        ...
        {
            return EntityEx.DelByID<ParamsObj>(p_id, p_isNotify);
        }
        ...
        public static Task<Table<ParamsObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<ParamsObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<ParamsObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<ParamsObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<ParamsObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<ParamsObj>(p_filter, p_params);
        }
        ...
        {
            return EntityEx.GetNewID<ParamsObj>();
        }
        ...
        {
            return EntityEx.GetNewSeq<ParamsObj>(p_colName);
        }
        #endregion
    }
}