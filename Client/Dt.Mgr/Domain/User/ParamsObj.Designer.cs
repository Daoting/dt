...
namespace Dt.Mgr.Domain
{
    ...
    public partial class ParamsObj : Entity
    {
        ...
        {
            return EntityEx.DelByKey<ParamsObj>(p_keyName, p_keyVal);
        }
        ...
        public static Task<Table<ParamsObj>> Query(string p_filter = null)
        {
            return EntityEx.Query<ParamsObj>();
        }
        ...
        /// <returns>返回实体列表</returns>
        public static Task<Table<ParamsObj>> Page(int p_starRow, int p_pageSize, string p_filter = null)
        {
            return EntityEx.Page<ParamsObj>(p_starRow, p_pageSize, p_filter);
        }
        ...
        /// <returns>返回实体对象或null</returns>
        public static Task<ParamsObj> First(string p_filter)
        {
            return EntityEx.First<ParamsObj>(p_filter);
        }
