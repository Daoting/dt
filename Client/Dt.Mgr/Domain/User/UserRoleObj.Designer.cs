...
namespace Dt.Mgr.Domain
{
    ...
    public partial class UserRoleObj : Entity
    {
        ...
        public static Task<Table<UserRoleObj>> Query(string p_filter = null)
        {
            return EntityEx.Query<UserRoleObj>();
        }
        ...
        /// <returns>返回实体列表</returns>
        public static Task<Table<UserRoleObj>> Page(int p_starRow, int p_pageSize, string p_filter = null)
        {
            return EntityEx.Page<UserRoleObj>(p_starRow, p_pageSize, p_filter);
        }
        ...
        public static Task<UserRoleObj> First(string p_filter)
        {
            return EntityEx.First<UserRoleObj>(p_filter);
        }
