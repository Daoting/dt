...
namespace Dt.Mgr.Domain
{
    ...
    public partial class UserRoleObj : Entity
    {
        ...
        public static Task<Table<UserRoleObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<UserRoleObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<UserRoleObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<UserRoleObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        public static Task<UserRoleObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<UserRoleObj>(p_filter, p_params);
        }
