...
namespace Dt.Mgr.Domain
{
    ...
    public partial class UserParamsObj : Entity
    {
        ...
        public UserParamsObj(CellList p_cells) : base(p_cells) { }
        ...
        public static Task<Table<UserParamsObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<UserParamsObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<UserParamsObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<UserParamsObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        public static Task<UserParamsObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<UserParamsObj>(p_filter, p_params);
        }
