...
namespace Dt.Sample
{
    public sealed partial class FvHome : NaviWin
    {
        public FvHome()
        {
            InitializeComponent();
            ...
            {
                new NaviRow(Icons.分组, "格", typeof(CellsDemo), "基础编辑器，数据和界面的桥梁，通过设置属性指定交互行为和编辑方法，支持自定义"),
                new NaviRow(Icons.详细, "数据操作", typeof(FvData), "对二维表格数据的增删改或对普通对象的修改"),
                new NaviRow(Icons.小图标, "属性编辑器", typeof(FvObjData), "对控件或普通对象的属性进行编辑"),
