    ...
    public sealed partial class LvHome : Win
    {
        public LvHome()
        {
            ...
            _lv.Data = new Nl<CenterInfo>
            {
                ...
                new CenterInfo(Icons.修改, "自定义单元格", typeof(LvViewEx), "定义行样式、扩展列"),
                new CenterInfo(Icons.划卡, "行模板选择", typeof(LvListSelector), "根据数据动态选择行模板"),
                new CenterInfo(Icons.划卡, "动态行内容", typeof(LvRowView), "根据数据动态生成行UI内容"),
