...
namespace Dt.Cells.Data
{
    ...
    /// </summary>
    public class XYDataMarker : DataMarker, IXYDataPoint, IDataPoint
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Dt.Cells.Data.XYDataMarker" /> class.
        /// </summary>
        public XYDataMarker()
        {
        }

        internal XYDataMarker(SpreadXYDataSeries xyDataSeries, int pointIndex) : base(xyDataSeries, pointIndex)
        {
        }
