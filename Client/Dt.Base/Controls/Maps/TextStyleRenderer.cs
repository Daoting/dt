...
/// <summary>
/// 支持中文和IconFont，修改LabelStyleRenderer
/// https://github.com/Mapsui/Mapsui/blob/main/Mapsui.Rendering.Skia/SkiaStyles/LabelStyleRenderer.cs
/// </summary>
public class TextStyleRenderer : ISkiaStyleRenderer, IFeatureSize
{
    ...
    {
        var typeface = ScottPlot.Fonts.GetTypeface(font.FontFamily,
            font.Bold ? ScottPlot.FontWeight.Bold : ScottPlot.FontWeight.Normal,
            font.Italic ? ScottPlot.FontSlant.Italic : ScottPlot.FontSlant.Upright,
