...
public partial class MapView
{
    static MapView()
    {
        MapRenderer.RegisterStyleRenderer(typeof(TextStyle), new MyLabelStyleRenderer());
    ...
    static async Task AddFontFile()
    {
        try
        {
            ...
            DefaultFontPath = "file://" +  Path.GetFullPath(file.Path);
        }
        catch { }
    }
...
public class MyLabelStyleRenderer : ISkiaStyleRenderer, IFeatureSize
{
    ...
    {
        //var typeface = SKTypeface.FromFile(font.FontSource.Source.Substring(7));
