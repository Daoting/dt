...
namespace Dt.Base
{
    ...
    public partial class Mi : DtControl
    {
        ...
        public static readonly DependencyProperty ShowBtnProperty = DependencyProperty.Register(
            "ShowBtn",
            typeof(bool),
            typeof(Mi),
            new PropertyMetadata(false, OnShowBtnChanged));
        ...
        static void OnShowBtnChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            Mi mi = (Mi)d;
        ...
        public Mi(
            string id,
            Icons? icon = null,
            Action<Mi> click = null,
            Action call = null,
            bool? isCheckable = null,
            bool? isChecked = null,
            bool? enable = null,
            bool? visible = null)
            : this()
        ...
        public bool ShowBtn
        {
            get { return (bool)GetValue(ShowBtnProperty); }
        ...
        void AddMoreBtn()
        {
            ...
            if (Kit.IsPhoneUI)
            {
                btn.Style = Res.浅字符按钮;
                btn.FontSize = 12;
                btn.Padding = new Thickness(5, 19, 5, 19);
            ...
            else
            {
                btn.Style = Res.字符按钮;
                btn.FontSize = 12;
                btn.Padding = new Thickness(5, 14, 5, 14);
