...
namespace Dt.Base
{
    ...
    public partial class Menu : Control, IEnumerable
    {
        #region 成员变量
        MenuPanel _panel;
        Mi _selectedMi;
        ...
        /// {
        ///     { "保存", Icons.保存 },
        ///     { "选择项", Icons.pos机, OnBinding, OnAdd },
        /// };
        /// </summary>
        /// <param name="id"></param>
        ...
        public Mi Add(
            ...
            bool? visible = null)
        {
            Mi mi = new Mi(id, icon, click, call, isCheckable, isChecked, enable, visible);
            Items.Add(mi);
            return mi;
        }
