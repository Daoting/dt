...
namespace Dt.Cells.UI
{
    public partial class SheetView : Panel, IXmlSerializable
    {
        ...
        Windows.Foundation.Size _availableSize;
        ...
        Windows.Foundation.Point _floatingObjectsMovingResizingOffset = new Windows.Foundation.Point(0.0, 0.0);
        int _floatingObjectsMovingResizingStartColumn = -2;
        Windows.Foundation.Point _floatingObjectsMovingResizingStartPoint = new Windows.Foundation.Point(0.0, 0.0);
        Windows.Foundation.Rect _floatingObjectsMovingResizingStartPointCellBounds = new Windows.Foundation.Rect(0.0, 0.0, 0.0, 0.0);
        int _floatingObjectsMovingResizingStartRow = -2;
        Dictionary<string, Windows.Foundation.Point> _floatingObjectsMovingStartLocations = new Dictionary<string, Windows.Foundation.Point>();
        ...
        static readonly Windows.Foundation.Size GCSPREAD_DefaultSize = new Windows.Foundation.Size(500.0, 500.0);
