...
namespace Dt.Cells.UI
{
    internal partial class FloatingObjectContainer : Panel
    {
        ...
        public FloatingObjectContainer(Dt.Cells.Data.FloatingObject floatingObject, CellsPanel parentViewport)
        {
            ...
            _outBorder.CornerRadius = new Microsoft.UI.Xaml.CornerRadius(5.0);
            base.Children.Add(_outBorder);
            _glyphGrid = new Grid();
            base.Children.Add(_glyphGrid);
            RowDefinition definition = new RowDefinition();
            definition.Height = new Microsoft.UI.Xaml.GridLength(7.0);
            ...
            definition2.Height = new Microsoft.UI.Xaml.GridLength(7.0);
            _glyphGrid.RowDefinitions.Add(definition2);
            ColumnDefinition definition3 = new ColumnDefinition();
            definition3.Width = new Microsoft.UI.Xaml.GridLength(7.0);
            ...
            definition4.Width = new Microsoft.UI.Xaml.GridLength(7.0);
            ...
            _innerBorder.CornerRadius = new Microsoft.UI.Xaml.CornerRadius(10.0);
        ...
        void UpdateElements(bool isSelected)
        {
            if (isSelected)
            {
                ...
                _outBorder.BorderBrush = BorderBrush;
                _contentPanel.CornerRadius = new Microsoft.UI.Xaml.CornerRadius(10.0);
                _contentPanel.Background = new SolidColorBrush(Colors.Transparent);
            ...
            else
            {
                ...
                _contentPanel.CornerRadius = new Microsoft.UI.Xaml.CornerRadius(0.0);
