...
-- ----------------------------
BEGIN;
INSERT INTO `cm_file_my` (`ID`, `ParentID`, `Name`, `IsFolder`, `ExtName`, `Info`, `Ctime`, `UserID`) VALUES (140724076930789376, NULL, '新目录1', 1, NULL, '', '2020-10-23 15:47:16', 1), (140724154458304512, 140724076930789376, 'b', 1, NULL, '', '2020-10-23 15:47:34', 1), (141735914371936256, NULL, '新目录12', 1, NULL, '', '2020-10-26 10:48:01', 2), (456284281217503232, NULL, '新Tab', 1, '', '', '2023-03-13 10:30:55', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_group` (`ID`, `Name`, `Note`) VALUES (454483802783240192, '分组1', ''), (454484847190102016, '2', ''), (454484924033945600, '3', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_group_role` (`GroupID`, `RoleID`) VALUES (454483802783240192, 2), (454483802783240192, 22844822693027840), (454484924033945600, 22844822693027840), (454483802783240192, 152695933758603264), (454484924033945600, 152695933758603264), (454483802783240192, 152696004814307328);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_option_group` (`ID`, `Name`) VALUES (1, '民族'), (2, '学历'), (3, '地区'), (4, '性别'), (5, '数据类型'), (456659310463700992, '新组');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_permission` (`ID`, `Name`, `Note`) VALUES (1, '公共文件管理', '禁止删除'), (2, '素材库管理', '禁止删除'), (455253883184238592, '测试212', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_role` (`ID`, `Name`, `Note`) VALUES (1, '任何人', '所有用户默认都具有该角色，不可删除'), (2, '系统管理员', '系统角色，不可删除'), (22844822693027840, '收发员', ''), (152695933758603264, '市场经理', ''), (152696004814307328, '综合经理', ''), (152696042718232576, '财务经理', ''), (456324988334526464, '新角色1', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_role_menu` (`RoleID`, `MenuID`) VALUES (2, 2), (2, 3), (2, 4), (2, 5), (2, 6), (1, 7), (1, 8), (1, 9), (2, 10), (1, 15315637929975808), (2, 18860286065975296), (22844822693027840, 154430055023640576), (22844822693027840, 455168269038407680);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_role_per` (`RoleID`, `PerID`) VALUES (1, 1), (1, 2), (22844822693027840, 455253883184238592), (152695933758603264, 455253883184238592);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_user_group` (`UserID`, `GroupID`) VALUES (1, 454483802783240192), (1, 454484924033945600), (3, 454484924033945600);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_user_params` (`UserID`, `ParamID`, `Value`, `Mtime`) VALUES (2, 1, 'false', '2020-12-04 13:29:05');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_user_role` (`UserID`, `RoleID`) VALUES (1, 2), (1, 22844822693027840), (1, 152695933758603264), (1, 152696004814307328), (2, 2), (2, 22844822693027840), (2, 152695933758603264), (3, 2), (149709966847897600, 2), (149709966847897600, 152695933758603264), (152695627289198592, 152696004814307328), (152695790787362816, 152696042718232576), (247170018466197504, 22844822693027840);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cm_wfi_prc` (`ID`, `PrcdID`, `Name`, `Status`, `Dispidx`, `Ctime`, `Mtime`) VALUES (162025231350624256, 152588581545967616, 'a', 1, 58, '2020-12-21 10:30:29', '2020-12-21 16:45:13'), (162401333600448512, 152588581545967616, '关于新冠疫情的批示', 0, 59, '2020-12-22 11:25:22', '2020-12-22 11:25:22'), (457384396879581184, 152588581545967616, '阿斯蒂芬', 0, 64, '2023-03-16 11:22:27', '2023-03-16 11:22:27'), (457388173615452160, 152588581545967616, '疫情在', 0, 65, '2023-03-16 11:37:33', '2023-03-16 11:37:33');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_cache_tbl1` (`ID`, `Phone`, `Name`) VALUES (454454068519129088, 'ca4f271212bc4add946c55feed7400bb', '3917'), (484620968746045440, '3f435d84c76a46e29002f467a4cd0187', '7425'), (484621133057904640, '3329d521b2134b0195083828152cb5b0', '1786'), (484624179913576448, 'd80e785d1d44472abe88723e4ed17ca8', '156');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_par_tbl` (`ID`, `Name`) VALUES (443588385522601984, '91471c9846a44fe8a7fc4b76e9f702ea'), (443588583535693824, '新增'), (443588895352836096, '新增'), (443588932694724608, '新增'), (445140374589034496, '新增'), (446130095742013440, '新增'), (484622270804807680, '新增'), (484622408633831424, '新增'), (484623850568437760, '新增'), (484623946693496832, '新增');
COMMIT;
...
CREATE TABLE `demo_virtbl1`  (
  `ID` bigint(20) NOT NULL,
  `Name1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称1',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_virtbl1` (`ID`, `Name1`) VALUES (484613811564728320, '新1'), (484613939734269952, '新1'), (484614242416218112, '批增1'), (484621407772233728, '新1'), (484623466739290112, '新1');
COMMIT;
...
CREATE TABLE `demo_virtbl2`  (
  `ID` bigint(20) NOT NULL,
  `Name2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称2',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_virtbl2` (`ID`, `Name2`) VALUES (484613811564728320, '新2'), (484613939734269952, '新2'), (484614242416218112, '批增2'), (484621407772233728, '新2'), (484623466739290112, '新2');
COMMIT;
...
CREATE TABLE `demo_virtbl3`  (
  `ID` bigint(20) NOT NULL,
  `Name3` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称3',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_virtbl3` (`ID`, `Name3`) VALUES (484613811564728320, '新3'), (484613939734269952, '新3'), (484614242416218112, '批增3'), (484621407772233728, '新3'), (484623466739290112, '新3');
COMMIT;
...
CREATE TABLE `demo_大儿`  (
  `ID` bigint(20) NOT NULL,
  `ParentID` bigint(20) NOT NULL,
  `大儿名` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `parendid`(`ParentID`) USING BTREE,
  CONSTRAINT `parendid` FOREIGN KEY (`ParentID`) REFERENCES `demo_父表` (`ID`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_大儿` (`ID`, `ParentID`, `大儿名`) VALUES (453807589999792128, 448686488403595264, '啊北侧'), (453810847795400704, 453810798449414144, 'bd'), (453811346175184896, 453810798449414144, 'asdf'), (453811364621733888, 453810798449414144, 'bde');
COMMIT;
...
CREATE TABLE `demo_父表`  (
  `ID` bigint(20) NOT NULL,
  `父名` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_父表` (`ID`, `父名`) VALUES (448686488403595264, '123'), (449120963746877440, '单位'), (453810798449414144, 'aaaa');
COMMIT;
...
CREATE TABLE `demo_基础`  (
  ...
  `限长4` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '限制最大长度4',
  `不重复` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '列值无重复',
  ...
  `值变事件` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '每次值变化时触发领域事件',
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_基础` (`ID`, `序列`, `限长4`, `不重复`, `禁止选中`, `禁止保存`, `禁止删除`, `值变事件`, `创建时间`, `修改时间`) VALUES (1, 1, 'adb', 'ddd', 1, 1, 1, 'a', '2023-01-17 10:08:10', '2023-01-17 10:08:14'), (447570516976357376, 6, '11', 'dd', 0, 0, 1, 'snv111', '2023-02-17 09:25:27', '2023-02-17 09:25:27');
COMMIT;
...
CREATE TABLE `demo_角色`  (
  `ID` bigint(20) NOT NULL COMMENT '角色标识',
  `角色名称` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '角色名称',
  `角色描述` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色描述',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色';
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_角色` (`ID`, `角色名称`, `角色描述`) VALUES (449487215124303872, 'xxx', 'df'), (449812931669938176, '管理员', ''), (449812975420723200, '维护1', ''), (449813053959065600, '维护2', '');
COMMIT;
...
CREATE TABLE `demo_角色权限`  (
  ...
  INDEX `fk_roleprvx_prvid`(`PrvID`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色关联的权限';

-- ----------------------------
-- Records of demo_角色权限
-- ----------------------------
BEGIN;
INSERT INTO `demo_角色权限` (`RoleID`, `PrvID`) VALUES (449487215124303872, 449812884102336512);
COMMIT;
...
CREATE TABLE `demo_扩展1`  (
  `ID` bigint(20) NOT NULL COMMENT '标识',
  `扩展1名称` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `禁止选中` tinyint(1) NOT NULL COMMENT '始终为false',
  `禁止保存` tinyint(1) NOT NULL COMMENT 'true时保存前校验不通过',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_扩展1` (`ID`, `扩展1名称`, `禁止选中`, `禁止保存`) VALUES (447555037331214336, 'a', 0, 0), (447577275388416000, '221', 0, 0), (447577372700463104, '', 0, 0);
COMMIT;
...
CREATE TABLE `demo_扩展2`  (
  `ID` bigint(20) NOT NULL COMMENT '标识',
  `扩展2名称` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `禁止删除` tinyint(1) NOT NULL COMMENT 'true时删除前校验不通过',
  `值变事件` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '每次值变化时触发领域事件',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_扩展2` (`ID`, `扩展2名称`, `禁止删除`, `值变事件`) VALUES (447555037331214336, 'a', 0, ''), (447577275388416000, '', 0, '221'), (447577372700463104, '', 0, '');
COMMIT;
...
CREATE TABLE `demo_权限`  (
  ...
  `权限名称` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限';
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_权限` (`ID`, `权限名称`) VALUES (449812852120768512, '删除'), (449812884102336512, '修改');
COMMIT;
...
CREATE TABLE `demo_收文`  (
  `ID` bigint(20) NOT NULL,
  `来文单位` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `来文时间` date NOT NULL,
  `密级` tinyint(4) UNSIGNED NOT NULL COMMENT '#密级#',
  `文件标题` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `文件附件` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `市场部经理意见` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `综合部经理意见` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_收文` (`ID`, `来文单位`, `来文时间`, `密级`, `文件标题`, `文件附件`, `市场部经理意见`, `综合部经理意见`, `收文完成时间`) VALUES (162025231350624256, '123', '2020-12-21', 0, 'a', '', '', '', '0001-01-01'), (162401333600448512, 'abc', '2020-12-22', 0, '关于新冠疫情的批示', '', '', '', '0001-01-01'), (457384396879581184, '', '2023-03-16', 0, '阿斯蒂芬', '', '', '', '0001-01-01'), (457388173615452160, '', '2023-03-16', 0, '疫情在', '', '', '', '0001-01-01');
COMMIT;
...
CREATE TABLE `demo_小儿`  (
  `ID` bigint(20) NOT NULL,
  `GroupID` bigint(20) NOT NULL,
  `小儿名` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `parentid`(`GroupID`) USING BTREE,
  CONSTRAINT `parentid` FOREIGN KEY (`GroupID`) REFERENCES `demo_父表` (`ID`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_小儿` (`ID`, `GroupID`, `小儿名`) VALUES (449113382156521472, 448686488403595264, 'wwww'), (453810909078376448, 453810798449414144, '34'), (453811464773324800, 453810798449414144, 'adgas');
COMMIT;
...
CREATE TABLE `demo_用户`  (
  `ID` bigint(20) NOT NULL COMMENT '用户标识',
  `手机号` char(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手机号，唯一',
  `姓名` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '姓名',
  `密码` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码的md5',
  PRIMARY KEY (`ID`) USING BTREE,
  UNIQUE INDEX `idx_phone`(`手机号`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统用户';
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_用户` (`ID`, `手机号`, `姓名`, `密码`) VALUES (449772627373871104, '13223333', '阿斯顿', ''), (453805638385946624, '111', '', ''), (453805654500462592, '222', '', '');
COMMIT;
...
CREATE TABLE `demo_用户角色`  (
  ...
  `RoleID` bigint(20) NOT NULL COMMENT '角色标识',
  PRIMARY KEY (`UserID`, `RoleID`) USING BTREE,
  INDEX `fk_userrolex_userid`(`UserID`) USING BTREE,
  INDEX `fk_userrolex_roleid`(`RoleID`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户关联的角色';

-- ----------------------------
-- Records of demo_用户角色
-- ----------------------------
BEGIN;
INSERT INTO `demo_用户角色` (`UserID`, `RoleID`) VALUES (449772627373871104, 449487215124303872), (449772627373871104, 449812931669938176);
COMMIT;
...
CREATE TABLE `demo_主表`  (
  `ID` bigint(20) NOT NULL,
  `主表名称` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `限长4` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '限制最大长度4',
  `不重复` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '列值无重复',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `demo_主表` (`ID`, `主表名称`, `限长4`, `不重复`) VALUES (447555037331214336, 'a', '', ''), (447577275388416000, '1', '222222', '121'), (447577372700463104, '', '', '1');
COMMIT;
