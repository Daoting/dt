...
CREATE TABLE cm_group (
  ID NUMBER(19, 0) NOT NULL COMMENT '组标识',
  Name varchar2(64) NOT NULL COMMENT '组名',
  Note varchar2(255) NOT NULL COMMENT '组描述',
  PRIMARY KEY (ID),
...
CREATE TABLE cm_group_role (
  GroupID NUMBER(19, 0) NOT NULL COMMENT '组标识',
  RoleID NUMBER(19, 0) NOT NULL COMMENT '角色标识',
...
CREATE TABLE cm_menu (
  ID NUMBER(19, 0) NOT NULL COMMENT '菜单标识',
  ParentID NUMBER(19, 0) DEFAULT NULL COMMENT '父菜单标识',
  Name varchar2(64) NOT NULL COMMENT '菜单名称',
  IsGroup NUMBER(1) NOT NULL COMMENT '分组或实例。0表实例，1表分组',
  ViewName varchar2(128) NOT NULL COMMENT '视图名称',
  Params varchar2(4000) NOT NULL COMMENT '传递给菜单程序的参数',
  Icon varchar2(128) NOT NULL COMMENT '图标',
...
CREATE TABLE cm_option (
  ID NUMBER(19, 0) NOT NULL COMMENT '标识',
  Name varchar2(64) NOT NULL COMMENT '选项名称',
  Dispidx int(11) NOT NULL COMMENT '显示顺序',
  GroupID NUMBER(19, 0) NOT NULL COMMENT '所属分组',
  PRIMARY KEY (ID) USING BTREE,
...
CREATE TABLE cm_option_group (
  ID NUMBER(19, 0) NOT NULL COMMENT '标识',
  Name varchar2(255) NOT NULL COMMENT '分组名称',
  PRIMARY KEY (ID)
...
CREATE TABLE cm_params (
  ID NUMBER(19, 0) NOT NULL COMMENT '用户参数标识',
...
CREATE TABLE cm_permission (
  ID NUMBER(19, 0) NOT NULL COMMENT '权限标识',
  Name varchar2(64) NOT NULL COMMENT '权限名称',
  Note varchar2(255) DEFAULT NULL COMMENT '权限描述',
  PRIMARY KEY (ID),
...
DROP TABLE cm_pub_comment;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE cm_pub_comment (
  ID NUMBER(19, 0) NOT NULL COMMENT '评论标识',
  PostID NUMBER(19, 0) NOT NULL COMMENT '文章标识',
...
DROP TABLE cm_pub_post;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE cm_pub_post (
  ID NUMBER(19, 0) NOT NULL COMMENT '文章标识',
  Title varchar2(255) NOT NULL COMMENT '标题',
  Cover varchar2(1024) NOT NULL COMMENT '封面',
  Summary varchar2(512) NOT NULL COMMENT '摘要',
  Content text NOT NULL COMMENT '内容',
  TempType tinyint(4) unsigned NOT NULL COMMENT '#PostTempType#在列表中显示时的模板类型',
  IsPublish NUMBER(1) NOT NULL COMMENT '是否发布',
  AllowCoverClick NUMBER(1) NOT NULL COMMENT '封面可点击',
  AllowComment NUMBER(1) NOT NULL COMMENT '是否允许评论',
  AddAlbumLink NUMBER(1) NOT NULL COMMENT '文章末尾是否添加同专辑链接',
  AddKeywordLink NUMBER(1) NOT NULL COMMENT '文章末尾是否添加同关键字链接',
  Url varchar2(128) NOT NULL COMMENT '文章地址',
  Dispidx int(11) NOT NULL COMMENT '显示顺序',
...
DROP TABLE cm_pub_post_album;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE cm_pub_post_album (
  PostID NUMBER(19, 0) NOT NULL COMMENT '文章标识',
  AlbumID NUMBER(19, 0) NOT NULL COMMENT '专辑标识',
...
DROP TABLE cm_pub_post_keyword;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE cm_pub_post_keyword (
  PostID NUMBER(19, 0) NOT NULL COMMENT '文章标识',
  Keyword varchar2(32) NOT NULL COMMENT '关键字',
...
CREATE TABLE cm_role (
  ID NUMBER(19, 0) NOT NULL COMMENT '角色标识',
  Name varchar2(32) NOT NULL COMMENT '角色名称',
  Note varchar2(255) DEFAULT NULL COMMENT '角色描述',
  PRIMARY KEY (ID) USING BTREE,
...
CREATE TABLE cm_role_menu (
  RoleID NUMBER(19, 0) NOT NULL COMMENT '角色标识',
  MenuID NUMBER(19, 0) NOT NULL COMMENT '菜单标识',
...
CREATE TABLE cm_role_per (
  RoleID NUMBER(19, 0) NOT NULL COMMENT '角色标识',
  PerID NUMBER(19, 0) NOT NULL COMMENT '权限标识',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE cm_rpt (
  ID NUMBER(19, 0) NOT NULL COMMENT '报表标识',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE cm_sql (
  id varchar2(128) NOT NULL COMMENT 'sql键值',
  sql varchar2(20000) NOT NULL COMMENT 'sql内容',
  note varchar2(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (id) USING BTREE
...
CREATE TABLE cm_user (
  ID NUMBER(19, 0) NOT NULL COMMENT '用户标识',
  Phone char(11) NOT NULL COMMENT '手机号，唯一',
  Name varchar2(32) NOT NULL COMMENT '姓名',
...
CREATE TABLE cm_wfd_atv (
  ID NUMBER(19, 0) NOT NULL COMMENT '活动标识',
  PrcID NUMBER(19, 0) NOT NULL COMMENT '流程标识',
  Name varchar2(64) NOT NULL COMMENT '活动名称，同时作为状态名称',
  ...
  ExecAtvID NUMBER(19, 0) DEFAULT NULL COMMENT '在执行者限制为3或4时选择的活动',
  AutoAccept NUMBER(1) NOT NULL COMMENT '是否自动签收，打开工作流视图时自动签收工作项',
  CanDelete NUMBER(1) NOT NULL COMMENT '能否删除流程实例和业务数据，0否 1',
  CanTerminate NUMBER(1) NOT NULL COMMENT '能否中止流程实例，中止一个流程是流程的一种非正常的结束，0否 1能',
...
CREATE TABLE cm_wfd_atv_role (
  AtvID NUMBER(19, 0) NOT NULL COMMENT '活动标识',
  RoleID NUMBER(19, 0) NOT NULL COMMENT '角色标识',
...
CREATE TABLE cm_wfd_prc (
  ID NUMBER(19, 0) NOT NULL COMMENT '流程标识',
  Name varchar2(64) NOT NULL COMMENT '流程名称',
  Diagram varchar2(21000) DEFAULT NULL COMMENT '流程图',
  IsLocked NUMBER(1) NOT NULL COMMENT '锁定标志，0表未锁定；1表锁定，不能创建流程实例，已启动的流程实例继续执行',
...
CREATE TABLE cm_wfd_trs (
  ID NUMBER(19, 0) NOT NULL COMMENT '迁移标识',
  PrcID NUMBER(19, 0) NOT NULL COMMENT '流程模板标识',
  SrcAtvID NUMBER(19, 0) NOT NULL COMMENT '起始活动模板标识',
  TgtAtvID NUMBER(19, 0) NOT NULL COMMENT '目标活动模板标识',
  IsRollback NUMBER(1) NOT NULL COMMENT '是否为回退迁移',
  TrsID NUMBER(19, 0) DEFAULT NULL COMMENT '类别为回退迁移时对应的常规迁移标识',
  PRIMARY KEY (ID),
...
CREATE TABLE cm_wfi_atv (
  ID NUMBER(19, 0) NOT NULL COMMENT '活动实例标识',
  PrciID NUMBER(19, 0) NOT NULL COMMENT '流程实例标识',
...
CREATE TABLE cm_wfi_item (
  ID NUMBER(19, 0) NOT NULL COMMENT '工作项标识',
  AtviID NUMBER(19, 0) NOT NULL COMMENT '活动实例标识',
...
CREATE TABLE cm_wfi_prc (
  ID NUMBER(19, 0) NOT NULL COMMENT '流程实例标识，同时为业务数据主键',
  PrcdID NUMBER(19, 0) NOT NULL COMMENT '流程模板标识',
...
CREATE TABLE cm_wfi_trs (
  ID NUMBER(19, 0) NOT NULL COMMENT '迁移实例标识',
  TrsdID NUMBER(19, 0) NOT NULL COMMENT '迁移模板标识',
...
CREATE TABLE fsm_file (
  ID NUMBER(19, 0) unsigned NOT NULL COMMENT '文件标识',
  Name varchar2(512) NOT NULL COMMENT '文件名称',
  Path varchar2(512) NOT NULL COMMENT '存放路径：卷/两级目录/id.ext',
...
CREATE TABLE sequence (
  id varchar2(64) NOT NULL COMMENT '序列名称',
...
DELIMITER ;;
CREATE DEFINER=dt@% FUNCTION nextval( v_seq_name varchar2 ( 200 ) ) RETURNS int(11)
BEGIN
DECLARE
	res INTEGER;
UPDATE sequence 
