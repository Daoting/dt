...
INSERT INTO `cm_role_menu` VALUES (1,2),(152696042718232576,2),(1,3),(1,4),(152695933758603264,4),(1,5),(152695933758603264,5),(1,6),(1,7),(1,15315637929975808),(2,18860286065975296),(1,139207663032332288),(2,142179186714210304),(2,144356540693737472),(22844822693027840,154430055023640576);
/*!40000 ALTER TABLE `cm_role_menu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cm_role_prv`
--

DROP TABLE IF EXISTS `cm_role_prv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm_role_prv` (
  `RoleID` bigint(20) NOT NULL COMMENT '角色标识',
...
--
-- Dumping data for table `cm_role_prv`
--

LOCK TABLES `cm_role_prv` WRITE;
/*!40000 ALTER TABLE `cm_role_prv` DISABLE KEYS */;
INSERT INTO `cm_role_prv` VALUES (2,'公共文件管理'),(152696004814307328,'公共文件管理'),(2,'素材库管理'),(152696004814307328,'素材库管理');
/*!40000 ALTER TABLE `cm_role_prv` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cm_user_params` VALUES (8411237852585984,'接收新任务','false','2020-12-04 13:29:05');
...
INSERT INTO `cm_user_role` VALUES (1,2),(1,22844822693027840),(1,152695933758603264),(8411237852585984,2),(8411237852585984,22844822693027840),(52998151791833088,2),(149709966847897600,2),(149709966847897600,152695933758603264),(152695627289198592,152696004814307328),(152695790787362816,152696042718232576),(238206296410419200,22844822693027840),(247170018466197504,22844822693027840);
...
CREATE TABLE `demo_基础` (
  ...
  `校验后台列` int(11) NOT NULL COMMENT '未和UI绑定，但校验',
...
INSERT INTO `demo_基础` VALUES (1,1,'adb','ddd',1,1,1,1,'a','2023-01-17 10:08:10','2023-01-17 10:08:14');
/*!40000 ALTER TABLE `demo_基础` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `demo_扩展`
--

DROP TABLE IF EXISTS `demo_扩展`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `demo_扩展` (
  `ID` bigint(20) NOT NULL COMMENT '标识',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `demo_扩展`
--

LOCK TABLES `demo_扩展` WRITE;
/*!40000 ALTER TABLE `demo_扩展` DISABLE KEYS */;
/*!40000 ALTER TABLE `demo_扩展` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `demo_收文` VALUES (162025231350624256,'123','2020-12-21',0,'a','','','','0001-01-01'),(162401333600448512,'abc','2020-12-22',0,'关于新冠疫情的批示','','','','0001-01-01');
/*!40000 ALTER TABLE `demo_收文` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `demo_hook`
--

DROP TABLE IF EXISTS `demo_hook`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `demo_hook` (
  `ID` bigint(20) NOT NULL COMMENT '标识',
  `MaxLength` varchar(16) NOT NULL COMMENT '限制最大长度',
  `NotNull` varchar(64) NOT NULL COMMENT '不为空',
  `Src` varchar(64) NOT NULL COMMENT '联动源',
  `Tgt` varchar(64) NOT NULL COMMENT '联动目标',
  `IsCheck` tinyint(1) NOT NULL COMMENT '联动源不为空可选中',
  `NoBinding` int(11) NOT NULL COMMENT '未和UI绑定',
  `NoHook` int(255) NOT NULL COMMENT '无值变化Hook',
  `NoDelete` tinyint(1) NOT NULL COMMENT '禁止删除',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Entity保存前、删除前、值变化前的回调样例';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `demo_hook`
--

LOCK TABLES `demo_hook` WRITE;
/*!40000 ALTER TABLE `demo_hook` DISABLE KEYS */;
INSERT INTO `demo_hook` VALUES (431686630056677376,'限长1','非空','','',0,0,0,0),(431691317203980288,'限长w','非空','','',0,22,78,0),(431697359648346112,'限长x','非空','','',0,0,44,0);
/*!40000 ALTER TABLE `demo_hook` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sequence` VALUES ('cm_menu+dispidx',87),('cm_option+dispidx',1022),('cm_pub_post+dispidx',165),('cm_wfd_prc+dispidx',11),('cm_wfi_item+dispidx',162),('cm_wfi_prc+dispidx',63);
...
-- Dump completed on 2023-01-20 12:20:58
