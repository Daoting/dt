...
-- ----------------------------
INSERT INTO "cm_file_pub" VALUES (1, NULL, '公共文件', '1', NULL, '', '2020-10-21 15:19:20');
INSERT INTO "cm_file_pub" VALUES (2, NULL, '素材库', '1', NULL, '', '2020-10-21 15:20:21');
...
-- Records of cm_menu
-- ----------------------------
INSERT INTO "cm_menu" VALUES (1, NULL, '工作台', 't', '', NULL, '搬运工', NULL, 1, 'f', '2019-03-07 10:45:44', '2019-03-07 10:45:43');
...
INSERT INTO "cm_menu" VALUES (4, 1, '系统角色', 'f', '系统角色', NULL, '两人', '角色管理及所属分组、关联用户、拥有菜单、授予权限的管理', 4, 'f', '2019-11-08 11:47:21', '2019-11-08 11:48:22');
INSERT INTO "cm_menu" VALUES (5, 1, '基础权限', 'f', '基础权限', NULL, '审核', '按照模块、功能两级目录管理的权限和关联的角色', 5, 'f', '2019-03-12 09:11:22', '2019-03-07 11:23:40');
...
-- ----------------------------
CREATE INDEX "fk_permission" ON "cm_permission" (
  "func_id" ASC
);
...
-- ----------------------------
CREATE INDEX "fk_permission_func" ON "cm_permission_func" (
  "module_id" ASC
);
...
ALTER TABLE "cm_permission" 
  ADD CONSTRAINT "fk_permission_func" FOREIGN KEY ("func_id") REFERENCES "cm_permission_func" ("id");

ALTER TABLE "cm_permission_func" 
  ADD CONSTRAINT "fk_permission_module" FOREIGN KEY ("module_id") REFERENCES "cm_permission_module" ("id");
...
-- ----------------------------
ALTER TABLE "cm_group_role" ADD CONSTRAINT "fk_group_role_groupid" FOREIGN KEY ("group_id") REFERENCES "cm_group" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_group_role" ADD CONSTRAINT "fk_group_role_roleid" FOREIGN KEY ("role_id") REFERENCES "cm_role" ("id") ON DELETE CASCADE;
...
-- ----------------------------
ALTER TABLE "cm_role_menu" ADD CONSTRAINT "fk_role_menu_menuid" FOREIGN KEY ("menu_id") REFERENCES "cm_menu" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_role_menu" ADD CONSTRAINT "fk_role_menu_roleid" FOREIGN KEY ("role_id") REFERENCES "cm_role" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_role_per
-- ----------------------------
ALTER TABLE "cm_role_per" ADD CONSTRAINT "fk_role_per_perid" FOREIGN KEY ("per_id") REFERENCES "cm_permission" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_role_per" ADD CONSTRAINT "fk_role_per_roleid" FOREIGN KEY ("role_id") REFERENCES "cm_role" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_user_group
-- ----------------------------
ALTER TABLE "cm_user_group" ADD CONSTRAINT "fk_user_group_groupid" FOREIGN KEY ("group_id") REFERENCES "cm_group" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_user_group" ADD CONSTRAINT "fk_user_group_userid" FOREIGN KEY ("user_id") REFERENCES "cm_user" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_user_params
-- ----------------------------
ALTER TABLE "cm_user_params" ADD CONSTRAINT "fk_user_params_paramsid" FOREIGN KEY ("param_id") REFERENCES "cm_params" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_user_params" ADD CONSTRAINT "fk_user_params_userid" FOREIGN KEY ("user_id") REFERENCES "cm_user" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_user_role
-- ----------------------------
ALTER TABLE "cm_user_role" ADD CONSTRAINT "fk_user_role_roleid" FOREIGN KEY ("role_id") REFERENCES "cm_role" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_user_role" ADD CONSTRAINT "fk_user_role_userid" FOREIGN KEY ("user_id") REFERENCES "cm_user" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_wfd_atv
-- ----------------------------
ALTER TABLE "cm_wfd_atv" ADD CONSTRAINT "fk_wfd_atv_prcid" FOREIGN KEY ("prc_id") REFERENCES "cm_wfd_prc" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_wfd_atv_role
-- ----------------------------
ALTER TABLE "cm_wfd_atv_role" ADD CONSTRAINT "fk_wfd_atv_role_atvid" FOREIGN KEY ("atv_id") REFERENCES "cm_wfd_atv" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_wfd_atv_role" ADD CONSTRAINT "fk_wfd_atv_role_roleid" FOREIGN KEY ("role_id") REFERENCES "cm_role" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_wfd_trs
-- ----------------------------
ALTER TABLE "cm_wfd_trs" ADD CONSTRAINT "fk_wfd_trs_prcid" FOREIGN KEY ("prc_id") REFERENCES "cm_wfd_prc" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_wfi_atv
-- ----------------------------
ALTER TABLE "cm_wfi_atv" ADD CONSTRAINT "fk_wfi_atv_atvdid" FOREIGN KEY ("atvd_id") REFERENCES "cm_wfd_atv" ("id");
ALTER TABLE "cm_wfi_atv" ADD CONSTRAINT "fk_wfi_atv_prciid" FOREIGN KEY ("prci_id") REFERENCES "cm_wfi_prc" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_wfi_item
-- ----------------------------
ALTER TABLE "cm_wfi_item" ADD CONSTRAINT "fk_wfi_item_atviid" FOREIGN KEY ("atvi_id") REFERENCES "cm_wfi_atv" ("id") ON DELETE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table cm_wfi_prc
-- ----------------------------
ALTER TABLE "cm_wfi_prc" ADD CONSTRAINT "fk_wfi_prc_prcdid" FOREIGN KEY ("prcd_id") REFERENCES "cm_wfd_prc" ("id");

-- ----------------------------
-- Foreign Keys structure for table cm_wfi_trs
-- ----------------------------
ALTER TABLE "cm_wfi_trs" ADD CONSTRAINT "fk_wfi_trs_srcatviid" FOREIGN KEY ("src_atvi_id") REFERENCES "cm_wfi_atv" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_wfi_trs" ADD CONSTRAINT "fk_wfi_trs_tgtatviid" FOREIGN KEY ("tgt_atvi_id") REFERENCES "cm_wfi_atv" ("id") ON DELETE CASCADE;
ALTER TABLE "cm_wfi_trs" ADD CONSTRAINT "fk_wfi_trs_trsdid" FOREIGN KEY ("trsd_id") REFERENCES "cm_wfd_trs" ("id") ON DELETE CASCADE;
