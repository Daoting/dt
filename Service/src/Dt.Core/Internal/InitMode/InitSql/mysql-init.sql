...
(2, 1, '用户账号', 0, '用户账号', '', '钥匙', '用户账号及所属用户组管理、为用户分配角色、查看用户可访问菜单和已授权限', 2, 0, '2019-11-08 11:42:28', '2019-11-08 11:43:53'), 
(3, 1, '用户组', 0, '用户组', '', '分组', '管理用户组、组内用户，为用户组分配角色', 3, 0, '2023-03-10 08:34:49', '2023-03-10 08:34:49'), 
(4, 1, '系统角色', 0, '系统角色', '', '两人', '角色管理及所属分组、关联用户、拥有菜单、授予权限的管理', 4, 0, '2019-11-08 11:47:21', '2019-11-08 11:48:22'), 
(5, 1, '基础权限', 0, '基础权限', '', '审核', '按照模块、功能两级目录管理的权限和关联的角色', 5, 0, '2019-03-12 09:11:22', '2019-03-07 11:23:40'), 
(6, 1, '菜单管理', 0, '菜单管理', '', '大图标', '菜单和菜单组管理、将菜单授权给角色', 6, 0, '2019-03-11 11:35:59', '2019-03-11 11:35:58'), 
(7, 1, '报表设计', 0, '报表设计', '', '折线图', '报表管理及报表模板设计', 7, 0, '2020-10-19 11:21:38', '2020-10-19 11:21:38'), 
(8, 1, '流程设计', 0, '流程设计', '', '双绞线', '流程模板设计及流程实例查询', 8, 0, '2020-11-02 16:21:19', '2020-11-02 16:21:19'),
(9, 1, '参数定义', 0, '参数定义', '', '调色板', '参数名称、默认值的定义管理', 9, 0, '2019-03-12 15:35:56', '2019-03-12 15:37:10'), 
(10, 1, '基础选项', 0, '基础选项', '', '修理', '按照分组管理的选项列表，如民族、学历等静态列表', 10, 0, '2019-11-08 11:49:40', '2019-11-08 11:49:46'); 
...
-- ----------------------------
INSERT INTO `cm_role_menu` VALUES (2, 2), (2, 3), (2, 4), (2, 5), (2, 6), (2, 7), (2, 8), (2, 9), (2, 10);
