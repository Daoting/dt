...
-- ----------------------------
INSERT INTO "CM_FILE_MY" VALUES ('140724076930789376', NULL, '新目录1', '1', NULL, 'ab', TO_DATE('2020-10-23 15:47:16', 'SYYYY-MM-DD HH24:MI:SS'), '1');
INSERT INTO "CM_FILE_MY" VALUES ('140724154458304512', '140724076930789376', 'b', '1', NULL, 'a', TO_DATE('2020-10-23 15:47:34', 'SYYYY-MM-DD HH24:MI:SS'), '1');
INSERT INTO "CM_FILE_MY" VALUES ('141735914371936256', NULL, '新目录12', '1', NULL, 'a', TO_DATE('2020-10-26 10:48:01', 'SYYYY-MM-DD HH24:MI:SS'), '2');
INSERT INTO "CM_FILE_MY" VALUES ('456284281217503232', NULL, '新Tab', '1', '', 'a', TO_DATE('2023-03-13 10:30:55', 'SYYYY-MM-DD HH24:MI:SS'), '1');
COMMIT;
COMMIT;
...
CREATE TABLE "CM_WFD_ATV" (
  ...
  "AUTOACCEPT" NUMBER(4) ,
  "CANDELETE" NUMBER(4) ,
  "CANTERMINATE" NUMBER(4) ,
  "CANJUMPINTO" NUMBER(4) ,
  "TRANSKIND" NUMBER(4) ,
  "JOINKIND" NUMBER(4) ,
  "CTIME" DATE ,
  "MTIME" DATE 
...
CREATE TABLE "DEMO_CRUD" (
  ...
  "DISPIDX" NUMBER(11) ,
  "MTIME" DATE ,
  "ENABLEINSERTEVENT" NUMBER(4) ,
  "ENABLENAMECHANGEDEVENT" NUMBER(4) ,
  "ENABLEDELEVENT" NUMBER(4) 
)
;
...
CREATE TABLE "DEMO_收文" (
  ...
  "文件标题" NVARCHAR2(255) ,
  "文件附件" NVARCHAR2(512) ,
  "市场部经理意见" NVARCHAR2(255) ,
  "综合部经理意见" NVARCHAR2(255) ,
  "收文完成时间" DATE 
)
;
...
CREATE INDEX "FK_MYFILE_PARENTID"
  ON "CM_FILE_MY" ("PARENTID" ASC);
CREATE INDEX "FK_USER_USERID"
  ON "CM_FILE_MY" ("USERID" ASC);
...
CREATE INDEX "FK_GROUPROLE_ROLEID"
  ON "CM_GROUP_ROLE" ("ROLEID" ASC);
CREATE INDEX "FK_GROUPROLE_GROUPID"
  ON "CM_GROUP_ROLE" ("GROUPID" ASC);
...
CREATE INDEX "FK_ROLEMENU_MENUID"
  ON "CM_ROLE_MENU" ("MENUID" ASC);
CREATE INDEX "FK_ROLEMENU_ROLEID"
  ON "CM_ROLE_MENU" ("ROLEID" ASC);
...
CREATE INDEX "FK_ROLEPER_PERID"
  ON "CM_ROLE_PER" ("PERID" ASC);
CREATE INDEX "FK_ROLEPER_ROLEID"
  ON "CM_ROLE_PER" ("ROLEID" ASC);
...
CREATE INDEX "FK_USERGROUP_GROUPID"
  ON "CM_USER_GROUP" ("GROUPID" ASC);
CREATE INDEX "FK_USERGROUP_USERID"
  ON "CM_USER_GROUP" ("USERID" ASC);
...
CREATE INDEX "FK_USERPARAMS_USERID"
  ON "CM_USER_PARAMS" ("USERID" ASC);
CREATE INDEX "FK_USERPARAMS_PARAMSID"
  ON "CM_USER_PARAMS" ("PARAMID" ASC);
...
CREATE INDEX "FK_USERROLE_USERID"
  ON "CM_USER_ROLE" ("USERID" ASC);
CREATE INDEX "FK_USERROLE_ROLEID"
  ON "CM_USER_ROLE" ("ROLEID" ASC);
...
CREATE INDEX "FK_WFIATV_PRCIID"
  ON "CM_WFI_ATV" ("PRCIID" ASC);
CREATE INDEX "FK_WFIATV_ATVDID"
  ON "CM_WFI_ATV" ("ATVDID" ASC);
...
CREATE INDEX "FK_WFITRS_TRSDID"
  ON "CM_WFI_TRS" ("TRSDID" ASC);
CREATE INDEX "FK_WFITRS_SRCATVIID"
  ON "CM_WFI_TRS" ("SRCATVIID" ASC);
CREATE INDEX "FK_WFITRS_TGTATVIID"
  ON "CM_WFI_TRS" ("TGTATVIID" ASC);
...
CREATE INDEX "FK_USERROLEX_USERID"
  ON "DEMO_用户角色" ("USERID" ASC);
CREATE INDEX "FK_USERROLEX_ROLEID"
  ON "DEMO_用户角色" ("ROLEID" ASC);
