...
#else
            return await model.AccessInfo.GetDataAccess().Query<TEntity>(sql, p_params);
#endif
        }
...
#else
            return await model.AccessInfo.GetDataAccess().Page<TEntity>(p_starRow, p_pageSize, sql, p_params);
#endif
        }
...
#else
            return await model.AccessInfo.GetDataAccess().First<TEntity>(sql, p_params);
#endif
        }
...
#else
            return await model.AccessInfo.GetDataAccess().GetScalar<int>(sql, p_params);
#endif
        }
...
#else
            return await model.AccessInfo.GetDataAccess().First<TEntity>(sql, dt);
#endif
        }
