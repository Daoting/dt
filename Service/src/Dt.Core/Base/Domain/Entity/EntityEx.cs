...
namespace Dt.Core
{
    ...
    public static class EntityEx
    {
        ...
        /// <param name="p_isNotify">是否提示删除结果，客户端有效</param>
        /// <returns>true 删除成功</returns>
        public static async Task<bool> Delete<TEntity>(this Table<TEntity> p_tbl, bool p_isNotify = true)
            where TEntity : Entity
        {
        ...
        /// <param name="p_isNotify">是否提示删除结果，客户端有效</param>
        /// <returns>true 删除成功</returns>
        public static async Task<bool> Delete(this Table p_tbl, bool p_isNotify = true)
        {
            if (p_tbl == null || p_tbl.Count == 0)
                return false;
