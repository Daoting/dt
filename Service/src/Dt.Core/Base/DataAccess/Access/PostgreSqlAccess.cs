...
namespace Dt.Core
{
    ...
    {
        #region 构造方法
        public PostgreSqlAccess(DbAccessInfo p_info)
            : base(p_info)
        {
        ...
        protected override DbConnection CreateConnection()
            => new NpgsqlConnection(_dbInfo.ConnStr);
        ...
        */
        ...
        #region 表结构
        const string _sqlAllTbls = "select tablename from pg_tables where schemaname='public' order by tablename";
