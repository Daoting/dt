...
namespace Dt.Cm.Domain
{
    ...
    public partial class UserObj : Entity
    {
        ...
        {
            return EntityEx.DelByID<UserObj>(p_id, p_isNotify);
        }
        ...
        public static Task<Table<UserObj>> Query(string p_filter = null, object p_params = null)
        {
            return EntityEx.Query<UserObj>(p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体列表</returns>
        public static Task<Table<UserObj>> Page(int p_starRow, int p_pageSize, string p_filter = null, object p_params = null)
        {
            return EntityEx.Page<UserObj>(p_starRow, p_pageSize, p_filter, p_params);
        }
        ...
        /// <param name="p_params">参数值，支持Dict或匿名对象，默认null</param>
        /// <returns>返回实体对象或null</returns>
        public static Task<UserObj> First(string p_filter, object p_params = null)
        {
            return EntityEx.First<UserObj>(p_filter, p_params);
        }
