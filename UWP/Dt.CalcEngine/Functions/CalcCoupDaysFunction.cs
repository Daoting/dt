...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> number of days in the coupon period that contains the settlement date.
    /// </summary>
    public class CalcCoupDaysFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return (double) FinancialHelper.coupdays(time, time2, freq, basis);
        }
