...
{
    /// <summary>
    /// Returns the largest number in a field (column) of records in a 
    /// list or database that matches conditions you that specify.
    /// </summary>
    public class CalcDMaxFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return CalcConvert.ToResult(minValue);
        }
