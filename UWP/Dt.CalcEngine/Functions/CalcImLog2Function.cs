...
{
    /// <summary>
    /// Returns the <see cref="T:System.String" /> base-2 logarithm of a complex number in x + yi or x + yj text format.
    /// </summary>
    public class CalcImLog2Function : CalcBuiltinFunction
    {
        /// <summary>
        /// Returns the <see cref="T:System.String" /> base-2 logarithm of a complex number in x + yi or x + yj text format.
        /// </summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            double num5 = Math.Log(2.7182818284590451, 2.0);
