...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> variance based on the entire population. 
    /// In addition to numbers, text and logical values such as True and False are included in the calculation.
    /// </summary>
    public class CalcVarPAFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return CalcConvert.ToResult(Math.Max((double) 0.0, (double) (((num3 * num2) - (num * num)) / (num3 * num3))));
        }
