...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> standard deviation based on the entire population, including text and logical values.
    /// </summary>
    public class CalcStDevPAFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        /// </para>
        /// <para>
        /// Value1, value2, ... are 1 to 255 values corresponding to a population.
        ...
        public override object Evaluate(object[] args)
        {
            ...
            for (int i = 0; i < args.Length; i++)
            {
                ...
                {
                    double num8;
                    if (!CalcConvert.TryToDouble(args[i], out num8, true))
                    {
