...
{
    /// <summary>
    /// Returns the <see cref="T:System.String" /> number converted from octal to hexadecimal.
    /// </summary>
    public class CalcOct2HexFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            string str2 = EngineeringHelper.LongToString(number, 0x10L, (long) num);
