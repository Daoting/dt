...
{
    /// <summary>
    /// Returns the <see cref="T:System.Double" /> bond-equivalent yield for a Treasury bill.
    /// </summary>
    public class CalcTBillEqFunction : CalcBuiltinFunction
    {
        /// <summary>
        /// Returns the <see cref="T:System.Double" /> bond-equivalent yield for a Treasury bill.
        /// </summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            double num3 = 365.0 * num;
            double num4 = 360.0 - (num * num2);
            if (num4 == 0.0)
            {
            ...
            return CalcConvert.ToResult(num3 / num4);
        }
