...
namespace Dt.Charts
{
    ...
    public partial class PlotElement : Path, IPlotElement
    {
        ...
        Microsoft.UI.Xaml.Shapes.Shape IPlotElement.LegendShape
        {
        ...
        protected Microsoft.UI.Xaml.Shapes.Shape DefaultLegendShape
        {
            get
            {
                double num;
        ...
        protected virtual Microsoft.UI.Xaml.Shapes.Shape LegendShape
        {
        ...
        protected void AdjustLegendShape(Microsoft.UI.Xaml.Shapes.Shape shape)
        {
            if (shape != null)
            {
