...
namespace Dt.Xls.Chart
{
    ...
    /// </summary>
    public class ExcelScatterSeries : IExcelScatterSeries, IExcelChartSeriesBase
    {
        private List<IExcelDataPoint> _dataPoints;
        private List<IExcelTrendLine> _trendlines;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:Dt.Xls.Chart.ExcelScatterSeries" /> class.
        /// </summary>
        public ExcelScatterSeries()
        {
            this.Smoothing = true;
        }
