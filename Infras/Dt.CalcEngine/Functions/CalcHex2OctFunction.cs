...
{
    /// <summary>
    /// Returns the <see cref="T:System.String" /> number converted from hexadecimal to octal.
    /// </summary>
    public class CalcHex2OctFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            long number = EngineeringHelper.StringToLong(s, 0x10, out num3);
            if (num3 < s.Length)
            {
                return CalcErrors.Number;
            }
