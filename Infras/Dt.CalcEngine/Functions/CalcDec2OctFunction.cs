...
{
    /// <summary>
    /// Returns the <see cref="T:System.String" /> converted from decimal to octal.
    /// </summary>
    public class CalcDec2OctFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        /// If number is negative, places is ignored and DEC2OCT returns
        /// a 10-character (30-bit) octal number in which the most significant bit is the sign bit.
        /// The remaining 29 bits are magnitude bits.
        /// Negative numbers are represented using two's-complement notation.
        /// </para>
        /// <para>
        /// Places is the number of characters to use. If places is omitted,
        /// DEC2OCT uses the minimum number of characters necessary.
        ...
        public override object Evaluate(object[] args)
        {
            ...
            string str = EngineeringHelper.LongToString(number, 8L, (long) num2);
