...
{
    /// <summary>
    /// Checks whether the value is refers to the #N/A (value not available) error value.
    /// </summary>
    public class CalcIsNAFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return (bool) ((args[0] as CalcError) == CalcErrors.NotAvailable);
        }
