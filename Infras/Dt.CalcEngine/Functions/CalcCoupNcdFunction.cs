...
{
    /// <summary>
    /// Returns a <see cref="T:System.Double" /> number that represents the next coupon date after the settlement date.
    /// </summary>
    public class CalcCoupNcdFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return (double) FinancialHelper.coupncd(time, time2, freq);
        }
