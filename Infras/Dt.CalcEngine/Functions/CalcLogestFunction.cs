...
{
    /// <summary>
    /// Returns the <see cref="T:Dt.CalcEngine.CalcArray" /> array of values for an exponential curve that best fits your data.
    /// </summary>
    public class CalcLogestFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            if (((array.RowCount == array2.RowCount) && (array.ColumnCount == array2.ColumnCount)) && (flag || !flag2))
            {
                ...
                objArray[0, 0] = (double) Math.Exp(num11);
                objArray[0, 1] = (double) Math.Exp(num12);
                if (flag2)
                {
            ...
            {
                values[0, m] = (double) Math.Exp(numArray3[columnCount - m, columnCount + 1]);
            }
            if (flag2)
            {
