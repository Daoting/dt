...
{
    /// <summary>
    /// Returns the <see cref="T:System.String" /> common logarithm (base 10) of a complex number in x + yi or x + yj text format.
    /// </summary>
    public class CalcImLog10Function : CalcBuiltinFunction
    {
        /// <summary>
        /// Returns the <see cref="T:System.String" /> common logarithm (base 10) of a complex number in x + yi or x + yj text format.
        /// </summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            double num5 = Math.Log10(2.7182818284590451);
            return ComplexConvert.ToResult(new Complex(num5 * Math.Log(d), num5 * num4));
        }
