...
{
    /// <summary>
    /// Returns a <see cref="T:System.Double" /> number that represents the previous coupon date before the settlement date.
    /// </summary>
    public class CalcCoupPcdFunction : CalcBuiltinFunction
    {
        /// <summary>
        ...
        public override object Evaluate(object[] args)
        {
            ...
            return (double) FinancialHelper.couppcd(time, time2, freq);
        }
