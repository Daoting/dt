...
{
    /// <summary>
    /// Represents a "less than or equals" operator.
    /// </summary>
    public class CalcLessThanOrEqualOperator : CalcBinaryOperator
    {
        /// <summary>
        ...
        internal override object EvaluteSingleValueCore(object left, object right)
        {
            ...
            return ((num < num2) ? ((bool) true) : ((bool) num.ApproxEqual(num2)));
        }
