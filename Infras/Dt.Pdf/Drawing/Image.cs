...
namespace Dt.Pdf.Drawing
{
    ...
    {
        private static readonly System.Type[] _ImageTypes = new System.Type[] { typeof(PngImage), typeof(JpegImage), typeof(GifImage),  typeof(Jpeg2000Image),  typeof(BitmapImage) };
        /// <summary>
