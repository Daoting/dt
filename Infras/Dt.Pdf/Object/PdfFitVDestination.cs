...
namespace Dt.Pdf.Object
{
    ...
    /// within the window. A null value for left specifies that the current 
    /// value of that parameter is to be retained unchanged.
    /// </summary>
    public class PdfFitVDestination : PdfDestination
    {
        private float left;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:PdfFitVDestination" /> class.
        /// </summary>
        /// <param name="page">The page.</param>
        /// <param name="left">The left.</param>
        public PdfFitVDestination(PdfPage page, float left) : base(page)
        {
            this.left = left;
        }
