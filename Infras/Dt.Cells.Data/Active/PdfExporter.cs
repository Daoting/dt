...
namespace Dt.Cells.Data
{
    ...
    internal class PdfExporter
    {
        ...
        internal Image GetImage(ImageSource source)
        {
            ...
            Microsoft.UI.Xaml.Media.Imaging.BitmapImage image = source as Microsoft.UI.Xaml.Media.Imaging.BitmapImage;
            Stream stream = null;
            try
            {
                if ((image != null) && (image.UriSource != null))
                {
                    try
                    {
                        Uri uri1 = ((Microsoft.UI.Xaml.Media.Imaging.BitmapImage)source).UriSource;
