...
namespace Dt.UIDemo
{
    public partial class RptTabDemo : Win
    {
        ...
        async void OnLocal(object sender, RoutedEventArgs e)
        {
            ...
            {
                string define = null;
                var file = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Dt.UIDemo/Files/Content/zh.rpt"));
        ...
        {
            _rpt.LoadReport(new RptInfo { Uri = "ms-appx:///Dt.UIDemo/Files/Content/zh.rpt" });
        }

        void OnEmbedded(object sender, RoutedEventArgs e)
        {
            _rpt.LoadReport(new RptInfo { Uri = "embedded://Dt.UIDemo/Dt.UIDemo.Files.Embed.模板.综合.rpt" });
        }

        void OnNoMenu(object sender, RoutedEventArgs e)
        {
            _rpt.LoadReport(new RptInfo { Uri = "embedded://Dt.UIDemo/Dt.UIDemo.Files.Embed.模板.无工具栏.rpt" });
        }

        void OnContextMenu(object sender, RoutedEventArgs e)
        {
            _rpt.LoadReport(new RptInfo { Uri = "embedded://Dt.UIDemo/Dt.UIDemo.Files.Embed.模板.右键菜单.rpt" });
        }

        void OnCustomMenu(object sender, RoutedEventArgs e)
        {
            _rpt.LoadReport(new RptInfo { Uri = "embedded://Dt.UIDemo/Dt.UIDemo.Files.Embed.模板.交互脚本.rpt" });
        }
    }
}