DROP TABLE demo_大儿;
DROP TABLE demo_小儿;
DROP TABLE demo_角色权限;
DROP TABLE demo_用户角色;
DROP TABLE demo_cache_tbl1;
DROP TABLE demo_child_tbl1;
DROP TABLE demo_child_tbl2;
DROP TABLE demo_crud;
DROP TABLE demo_par_tbl;
DROP TABLE demo_virtbl1;
DROP TABLE demo_virtbl2;
DROP TABLE demo_virtbl3;
DROP TABLE demo_父表;
DROP TABLE demo_基础;
DROP TABLE demo_角色;
DROP TABLE demo_扩展1;
