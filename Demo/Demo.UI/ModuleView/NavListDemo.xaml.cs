    ...
    public partial class NavListDemo : Win
    {
        ...
        void OnTitleIconDesc(object sender, RoutedEventArgs e)
        {
            _nav.Data = new Nl<Nav>
            {
                ...
                new Nav("查找图标", typeof(IconWin), Icons.图片) { Desc = "内置的矢量文字，可用作图标、提示" },
            };
        }
        ...
        void OnTitleIcon(object sender, RoutedEventArgs e)
        {
            _nav.Data = new Nl<Nav>
            {
                ...
                new Nav("查找图标", typeof(IconWin), Icons.图片),
        ...
        void OnTitleDesc(object sender, RoutedEventArgs e)
        {
            _nav.Data = new Nl<Nav>
            {
                new Nav("查找图标", typeof(IconWin)) { Desc = "内置的矢量文字，可用作图标、提示" },
        ...
        void OnMisc(object sender, RoutedEventArgs e)
        {
            _nav.Data = new Nl<Nav>
            {
                ...
                new Nav { Type = typeof(BlankWin), Desc = "行/项高度默认NaN，表示自动高度，\r\n因NavList的数据行数较少，每项的内容多少不同！\r\n设置0时表示以第一项高度为准，\r\n大于0时表示固定行/项高度。", Warning = "12" },
            };
        }
        ...
        void OnDesc(object sender, RoutedEventArgs e)
        {
            _nav.Data = new Nl<Nav>
            {
                new Nav { Type = typeof(DlgDemo), Desc = "对话框" },
                new Nav { Type = typeof(SingleViewWin), Desc = "主区窗口" },
                new Nav { Type = typeof(IconWin), Desc = "查找图标" },
                new Nav { Type = typeof(BlankWin), Desc = "空白窗口" },
            };
        }
    }
}