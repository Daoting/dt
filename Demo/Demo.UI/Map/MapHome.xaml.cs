...
public sealed partial class MapHome : Win
{
    ...
    void Jz()
    {
        ...
        tbl.AddRow(new { group = "百度", name = "百度地图", cls = typeof(BaiduBase) });
        tbl.AddRow(new { group = "百度", name = "卫星地图", cls = typeof(BaiduSatellite) });
        tbl.AddRow(new { group = "百度", name = "卫星地图标注", cls = typeof(BaiduSatelliteLabel) });
