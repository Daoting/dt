...
public class CustomSvgColor
{
    const double _circumferenceOfTheEarth = 40075017;
    ...
    public Task<Map> Create()
    {
        ...
        map.Widgets.Add(CreateTextBox("This samples applies custom colors for a specific element of an SVG."));
