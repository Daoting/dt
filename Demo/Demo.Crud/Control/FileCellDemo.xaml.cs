    ...
    public partial class FileCellDemo : Win
    {
        ...
        void LoadData()
        {
            ...
            _fv.Data = tbl.AddRow(new
            {
                ...
                file2 = "[[\"photo/项目文档.docx\",\"项目文档\",\"docx文件\",13071,\"daoting\",\"2020-03-13 10:37\"],[\"photo/mov.mp4\",\"mov\",\"00:00:10 (320 x 176)\",788493,\"daoting\",\"2020-03-13 10:37\"],[\"photo/文本文档.txt\",\"文本文档\",\"txt文件\",8,\"daoting\",\"2020-03-13 10:37\"]]",
        ...
        void OnChanged(FvCell arg1, object e)
        {
            Kit.Msg("文件列表变化");
        }
    }
